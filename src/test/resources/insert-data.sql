insert into materials (id, name, item_level, rarity, sell_price) values
...
-- Recipes
insert into recipes (id, name, item_level, rarity, profession, sell_price) values
...
-- Ingredients
insert into ingredients(id, recipe_id, material_id, quantity) values
 (1, 1, 1, 16),
 (2, 1, 4, 12),
 (3, 1, 5, 6),
 (4, 1, 6, 2);
